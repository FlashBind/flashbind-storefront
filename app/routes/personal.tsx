        ...
        <div className="max-w-5xl mx-auto mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/50 backdrop-blur-sm border border-slate-200 rounded-[2rem] p-8 text-center flex flex-col items-center transition-all duration-300 hover:shadow-lg hover:bg-white">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">A finder can tap the tag to view the owner contact details saved in the pet’s profile.</p>
            </div>
            <div className="bg-white/50 backdrop-blur-sm border border-slate-200 rounded-[2rem] p-8 text-center flex flex-col items-center transition-all duration-300 hover:shadow-lg hover:bg-white">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">Designed for everyday collar use. Final material and water-resistance specifications will be confirmed before launch.</p>
            </div>
            <div className="bg-white/50 backdrop-blur-sm border border-slate-200 rounded-[2rem] p-8 text-center flex flex-col items-center transition-all duration-300 hover:shadow-lg hover:bg-white">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">No FlashBind app is required for the finder, and NFC works with most modern smartphones.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto text-center py-16">
            ...
            <div className="flex justify-center gap-4 mt-14">
              <a href="https://instagram.com/flashbind_nfc" target="_blank" rel="noopener noreferrer" className="flex items-center border border-gray-300 rounded-full px-6 py-2.5 text-slate-700 font-medium hover:bg-[#1E3A8A] hover:text-white hover:border-[#1E3A8A] no-underline hover:no-underline transition-all duration-300 group">
